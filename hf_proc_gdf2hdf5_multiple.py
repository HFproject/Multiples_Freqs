		...
		try:
		    ...
		    dirns = dirns[dirns.index(dirns[0]):]
                ...
                for dir in temp:
                    ...
                    #if os.path.isfile("%s/procdata_end_flag"%(dir)):  #Analiza los archivos de rawdata
                    if os.path.isfile("%s/%s"%(dir, freq_i.end_flag)):  #Se fija si existe el archivo "'end_flag'=procdata_end_fx_flag" en 
                        #print "removing folder: %s"%(dir)              #cada folder de datos "rawdata/*d*
